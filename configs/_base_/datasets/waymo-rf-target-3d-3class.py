...
labels_pth = '/home/wessam/src/ransac_preprocessing/pointclouds/base_gt/hv_kalman/'
...
train_pipeline = [
    ...
    dict(
        ...
        keys=['points', 'gt_bboxes_3d','range_image', 'range_index',  'gt_labels_3d'])
]
...
eval_pipeline = [
    ...
    dict(
        type='Pack3DDetInputs',
        keys=[
            'points','range_image', 'range_index', 'gt_bboxes_3d', 'gt_labels_3d', 'num_lidar_points_in_box', 'gt_scores_3d'
        ],
        meta_keys=[
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            ...
            skips_n=1,
            data_path=input_pth,
            labels_path=labels_pth,
            files_txt='/home/wessam/src/ransac_preprocessing/pointclouds/train_split.txt',
            backend_args=backend_args)))
val_dataloader = dict(
    batch_size=2,
    num_workers=0,
